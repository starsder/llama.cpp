...
$env:LLAMA_MOE_CACHE_MIB="2048"; $env:LLAMA_MOE_PREDICT_SMOE="0"; $env:LLAMA_MOE_PREDICT_FATE="0"
$env:LLAMA_MOE_SPLIT="1"; $env:LLAMA_MOE_INSERT_ON_MISS="1"; $env:LLAMA_MOE_DIRECT_READ="1"
$env:LLAMA_MOE_PREFETCH="0"; $env:LLAMA_MOE_MRS="1"; $env:LLAMA_MOE_MRS_ALPHA="0.75"; $env:LLAMA_MOE_MRS_TOPP="20"
...
& build-ple-trace-mrs\bin\llama-cli.exe @base *> bz10.txt
Write-Output "R10 done"
