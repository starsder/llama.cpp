...
& build-ple-trace-mrs\bin\llama-cli.exe -m 'F:\models\qwen38\unsloth-iq3-xxs\UD-IQ3_XXS\Qwen3.8-Flash-Next-UD-IQ3_XXS-00001-of-00003.gguf' -ngl 49 --cpu-moe --lazy-mode off --no-mmap -c 8192 --cache-type-k q8_0 --cache-type-v q8_0 -p 'The capital of France is' -n 4 --temp 0 -st --no-warmup --no-display-prompt > devpart-dbgng-out.txt 2> devpart-dbgng-err.txt
