...
- 原来源：`docs/rebuild-spec.md`（本地工作区快照，不能假定与已发布 master 相同）。
- 原文件 SHA-256：`bf8cd4a9a710ef47e7d55220888593ca831d3f1442c0274cf07fba42b6d0bc12`。
...
```powershell
git worktree add OTHER_SOURCE_TREES/llama-qwen4exp-clean a9e9c3c5
```
...
```powershell
# 在 OTHER_SOURCE_TREES/llama-qwen4exp-clean 里
